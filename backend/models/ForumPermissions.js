...
const ForumPermissionsSchema = new mongoose.Schema({
    ...
    userId: {type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true}, //the user who created it
    canPost: {type: Boolean, required: true},
    canModerate: {type: Boolean, required: true},
    createdAt: {type: Date, required: true, default: Date.now}
})

const ForumPermissions = mongoose.model("ForumPermissions", ForumPermissionsSchema)
