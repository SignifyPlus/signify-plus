...
class ForumMemberController {
    ...
    getAllForumMembers = async(request, response) =>{
        try {
            const forumMembers = await ServiceFactory.getForumMemberService.getDocuments();
    ...
    getForumMemberById = async(request, response) => {
        try {
            ...
            const forumMember = await ServiceFactory.getForumMemberService.getDocumentById(forumMemberId);
